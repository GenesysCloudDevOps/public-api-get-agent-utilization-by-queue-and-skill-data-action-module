A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Agent Utilization by Queue and Skill
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-agent-utilization-by-queue-and-skill-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Agent Utilization by Queue and Skill"
